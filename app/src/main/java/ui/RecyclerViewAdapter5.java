...
public class RecyclerViewAdapter5 extends RecyclerView.Adapter<RecyclerViewAdapter5.ViewHolder> {
    ...
    public RecyclerViewAdapter5(Context context, List<Item> itemList) {
    ...
    @NonNull
    @Override
    public RecyclerViewAdapter5.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapter5.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private void deleteItem(int id) {
            ...
            yesButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    QuintoDatab databaseHandler =new QuintoDatab(context);
