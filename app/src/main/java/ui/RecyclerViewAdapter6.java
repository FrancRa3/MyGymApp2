...
public class RecyclerViewAdapter6 extends RecyclerView.Adapter<RecyclerViewAdapter6.ViewHolder> {
    ...
    public RecyclerViewAdapter6(Context context, List<Item> itemList) {
    ...
    @NonNull
    @Override
    public RecyclerViewAdapter6.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapter6.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private void deleteItem(int id) {
            ...
            yesButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    SestoDatab databaseHandler =new SestoDatab(context);
