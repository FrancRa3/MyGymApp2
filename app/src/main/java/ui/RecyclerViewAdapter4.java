...
public class RecyclerViewAdapter4 extends RecyclerView.Adapter<RecyclerViewAdapter4.ViewHolder> {
    ...
    public RecyclerViewAdapter4(Context context, List<Item> itemList) {
    ...
    @NonNull
    @Override
    public RecyclerViewAdapter4.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapter4.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private void deleteItem(int id) {
            ...
            yesButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    QuartoDatab databaseHandler =new QuartoDatab(context);
