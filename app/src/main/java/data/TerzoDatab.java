...
public class TerzoDatab extends SQLiteOpenHelper {
    public TerzoDatab(@Nullable Context context) {
        super(context, "DataMerc",null, Constants.DB_VERSION);
    }

    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("CREATE TABLE " + "Mercoledi" + " ("
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        ...
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + "Mercoledi");
    ...
    public void addItem(Item item){
        ...
        sqLiteDatabase.insert("Mercoledi",null,values);
    ...
    public Item getItem(int id){
        ...
        Cursor cursor= sqLiteDatabase.query("Mercoledi",
    ...
    public int updateItem(Item item){
        ...
        return sqLiteDatabase.update("Mercoledi",values,Constants.KEY_ID+ "=?",
    ...
    public void deleteItem(int id){
        SQLiteDatabase sqLiteDatabase=this.getWritableDatabase();
        sqLiteDatabase.delete("Mercoledi",Constants.KEY_ID + "=?",
    ...
    public int getItemsCount(){
        String countQuery ="SELECT * FROM " + "Mercoledi";
        SQLiteDatabase sqLiteDatabase=this.getReadableDatabase();
