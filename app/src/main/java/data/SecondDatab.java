...
public class SecondDatab extends SQLiteOpenHelper {
    public SecondDatab(@Nullable Context context) {
        super(context, "DataMart",null, Constants.DB_VERSION);
    }

    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("CREATE TABLE " + "Martedi" + " ("
    ...
    public void addItem(Item item){
        ...
        sqLiteDatabase.insert("Martedi",null,values);
    ...
    public Item getItem(int id){
        ...
        Cursor cursor= sqLiteDatabase.query("Martedi",
    ...
    public int updateItem(Item item){
        ...
        return sqLiteDatabase.update("Martedi",values,Constants.KEY_ID+ "=?",
    ...
    public void deleteItem(int id){
        SQLiteDatabase sqLiteDatabase=this.getWritableDatabase();
        sqLiteDatabase.delete("Martedi",Constants.KEY_ID + "=?",
    ...
    public int getItemsCount(){
        String countQuery ="SELECT * FROM " + "Martedi";
        SQLiteDatabase sqLiteDatabase=this.getReadableDatabase();
