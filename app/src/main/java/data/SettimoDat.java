...
public class SettimoDat extends SQLiteOpenHelper {
    public SettimoDat(@Nullable Context context) {
        super(context, "DataDom",null, Constants.DB_VERSION);
    }

    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("CREATE TABLE " + "Domenica" + " ("
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        ...
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + "Domenica");
    ...
    public void addItem(Item item){
        ...
        sqLiteDatabase.insert("Domenica",null,values);
    ...
    public Item getItem(int id){
        ...
        Cursor cursor= sqLiteDatabase.query("Domenica",
    ...
    public int updateItem(Item item){
        ...
        return sqLiteDatabase.update("Domenica",values,Constants.KEY_ID+ "=?",
    ...
    public void deleteItem(int id){
        SQLiteDatabase sqLiteDatabase=this.getWritableDatabase();
        sqLiteDatabase.delete("Domenica",Constants.KEY_ID + "=?",
    ...
    public int getItemsCount(){
        String countQuery ="SELECT * FROM " + "Domenica";
        SQLiteDatabase sqLiteDatabase=this.getReadableDatabase();
