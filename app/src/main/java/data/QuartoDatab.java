...
public class QuartoDatab extends SQLiteOpenHelper {
    public QuartoDatab(@Nullable Context context) {
        super(context, "DataGiov",null, Constants.DB_VERSION);
    }

    @Override
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("CREATE TABLE " + "Giovedi" + " ("
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        ...
        sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + "Giovedi");
    ...
    public void addItem(Item item){
        ...
        sqLiteDatabase.insert("Giovedi",null,values);
    ...
    public Item getItem(int id){
        ...
        Cursor cursor= sqLiteDatabase.query("Giovedi",
    ...
    public int updateItem(Item item){
        ...
        return sqLiteDatabase.update("Giovedi",values,Constants.KEY_ID+ "=?",
    ...
    public void deleteItem(int id){
        SQLiteDatabase sqLiteDatabase=this.getWritableDatabase();
        sqLiteDatabase.delete("Giovedi",Constants.KEY_ID + "=?",
    ...
    public int getItemsCount(){
        String countQuery ="SELECT * FROM " + "Giovedi";
        SQLiteDatabase sqLiteDatabase=this.getReadableDatabase();
