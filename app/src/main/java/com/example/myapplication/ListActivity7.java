...
import ui.RecyclerViewAdapter7;
...
public class ListActivity7 extends AppCompatActivity {
    ...
    private RecyclerViewAdapter7 recyclerViewAdapter;
    private List<Item> itemList;
    private SettimoDat databaseHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHandler=new SettimoDat(this);
        ...
        recyclerViewAdapter=new RecyclerViewAdapter7(this,itemList);
    ...
    private void saveItem(View view) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                dialog.dismiss();
                startActivity(new Intent(ListActivity7.this,ListActivity7.class));
                finish();
            }
        },1200);
