...
import ui.RecyclerViewAdapter6;
...
public class ListActivity6 extends AppCompatActivity {
    ...
    private RecyclerViewAdapter6 recyclerViewAdapter;
    private List<Item> itemList;
    private SestoDatab databaseHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHandler=new SestoDatab(this);
        ...
        recyclerViewAdapter=new RecyclerViewAdapter6(this,itemList);
    ...
    private void saveItem(View view) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                dialog.dismiss();
                startActivity(new Intent(ListActivity6.this,ListActivity6.class));
                finish();
            }
        },1200);
