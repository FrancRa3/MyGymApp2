...
import ui.RecyclerViewAdapter4;
...
public class ListActivity4 extends AppCompatActivity {
    ...
    private RecyclerViewAdapter4 recyclerViewAdapter;
    private List<Item> itemList;
    private QuartoDatab databaseHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHandler=new QuartoDatab(this);
        ...
        recyclerViewAdapter=new RecyclerViewAdapter4(this,itemList);
    ...
    private void saveItem(View view) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                dialog.dismiss();
                startActivity(new Intent(ListActivity4.this,ListActivity4.class));
                finish();
            }
        },1200);
