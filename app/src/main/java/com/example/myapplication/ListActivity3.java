...
import data.TerzoDatab;
import ui.RecyclerViewAdapter;
import ui.RecyclerViewAdapter3;
...
public class ListActivity3 extends AppCompatActivity{
    ...
    private TerzoDatab databaseHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseHandler=new TerzoDatab(this);
        ...
        recyclerViewAdapter=new RecyclerViewAdapter3(this,itemList);
    ...
    private void saveItem(View view) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                dialog.dismiss();
                startActivity(new Intent(ListActivity3.this,ListActivity3.class));
                finish();
            }
        },1200);
